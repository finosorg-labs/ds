#!/bin/bash
# Coverage report generation script for finkit-ds
...
echo "============================================================"
echo "finkit-ds Coverage Report Generator"
echo "============================================================"
echo ""
...
echo ""
echo "============================================================"
echo "Coverage Report - DS Module"
echo "============================================================"
echo ""
...
for gcda in $(find "$BUILD_DIR/src/ds" -name "*.gcda" 2>/dev/null | sort); do
    dir=$(dirname "$gcda")
...
echo "  $BUILD_DIR/src/ds/CMakeFiles/ds_obj.dir/"
echo ""
